...
const UserAvailableCreditsBadge = () => {
  ...
  return (
    <Link href={"/billing"} className="w-full flex gap-5 py-5 bg-yellow-100 rounded-lg justify-center items-center hover:bg-gray-100 ">
        ...
        <span className="font-semibold capitalize flex">
            ...
            {!query?.isLoading && query.data && <CreateCountupWrapper value={query.data}/>}
